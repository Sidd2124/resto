...
const Contact = () => {
    ...
    return (
        <div className="ContactTop">
            <h1 className='ContactTitless'>Contact US</h1>
            <iframe
    ...
    <div className="form-group">
        ...
        <input type="email" id="email" placeholder='Enter Your Contact Details' name="from_name" />
    </div>
    <div className="form-group">
        <label htmlFor="message">Message</label>
        <textarea id="message" className='textarea' name="message" placeholder='Enter Your Massage' rows="4"></textarea>
    </div>
...
<a href="tel:+919347877159"><img className='WhatsAppLogo'  src={Dail} alt="Whats App Logo"/></a>
</div>
        </div>
    );
}
