...
const Store = () => {
    ...
    return (
        <div className="StoreTop">
            ...
            <h3 style={{color:'lightgrey'}} className="desriptionItems">Found {FilterItems.length} {updatedType} </h3>
            {FilterItems.length === 0 ? <div className="Noitems"><img className="NoitemLogo" src={Noitem} alt="Noitems" /><p>Apologies,requested food item is currently unavailable.</p></div> : <div className="itemslist">
